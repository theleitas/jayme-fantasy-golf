...
.standings-player-block { margin:7px 0; }
.standings-player-line { display:flex; align-items:center; gap:8px; min-width:0; margin:5px 0; font-size:1.1em; }
.standings-player-line .roster-player-headshot { width:40px; height:40px; }
.standings-player-line .roster-player-name { font-weight:900; }
.standings-player-score { color:#fff; font-weight:850; white-space:nowrap; }
.standings-player-status { color:#ddd; white-space:nowrap; }
.recent-hole-tape { display:inline-flex; align-items:center; gap:3px; flex-wrap:wrap; margin:3px 0 3px 48px; padding:4px 6px; border-radius:7px; background:rgba(255,255,255,.075); border:1px solid rgba(255,255,255,.14); }
.recent-hole-label { display:inline-flex; align-items:center; justify-content:center; background:#fff; color:#000; border-radius:4px; padding:2px 4px; font-size:.5rem; font-weight:950; letter-spacing:.04em; text-transform:uppercase; margin-right:2px; line-height:1; }
...
.make-pick-prompt { width:100%; border:2px solid currentColor; border-radius:8px; padding:8px 12px; margin:.45rem 0 .75rem 0; color:currentColor; background:rgba(255,255,255,.04); font-size:clamp(1rem, 3vw, 1.35rem); font-weight:1000; text-align:center; box-shadow:0 0 12px currentColor; display:flex; align-items:center; justify-content:center; gap:10px; position:relative; z-index:1; }
...
div[data-testid="stVerticalBlock"]:has(> div[data-testid="stLayoutWrapper"] > div[data-testid="stHorizontalBlock"] div[class*="st-key-pick_"]) { gap:7px!important; row-gap:7px!important; }
div[data-testid="stLayoutWrapper"]:has(div[class*="st-key-pick_"]) { margin:0!important; padding:0!important; }
div[data-testid="stElementContainer"]:has(.make-pick-prompt) { margin-bottom:8px!important; }
div[data-testid="stElementContainer"]:has(div[class*="st-key-pick_"]) { margin:0 0 7px 0!important; padding:0!important; }
...
def coach_photo_filename(coach_id):
    return COACH_PHOTOS.get(coach_id, f"{coach_id}.jpeg")
