...
.standings-player-block { background:rgba(255,255,255,.075); border:1px solid rgba(255,255,255,.14); border-radius:8px; padding:7px 9px 5px; margin:7px 0; }
...
.recent-hole-tape { display:flex; align-items:center; gap:3px; flex-wrap:wrap; margin:3px 0 3px 48px; }
